...
//
//        ALTER TABLE `".$this->getTable('sales/order')."` ADD `fee_amount_granted` DECIMAL( 10, 2 ) NOT NULL;
//        ALTER TABLE `".$this->getTable('sales/order')."` ADD `base_fee_amount_granted` DECIMAL( 10, 2 ) NOT NULL;
//
